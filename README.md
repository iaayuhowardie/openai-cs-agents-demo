...
> **Personal fork note:** I'm using this project to learn about multi-agent orchestration with the OpenAI Agents SDK. My notes and experiments are in the `notes/` folder.
